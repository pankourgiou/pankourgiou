Βάζω Schopenhauer στον Άσσο για να κρατήσουμε το 0->η μεγάλη απόδραση των 11
...
Making a super valueable and costful grande experiment doesn't exclude you to make smaller ones-->greek companies experiment much on the debt/charging money/Euros specially trade experiment-->i'll call it consumism--->consumism though is an ancient Hebrew experiment...the name is capital--->an eye for an eye a tooth for a tooth. Me an Sonya are the Cern type of experimentists--->we call it determinationism experiment-->so a lawyer should know if my determinationism is powerful enough to have a personal doctor(I would prefer an eye doctor/psychologer too) and if I can have my bot assistan as assistant in life...so if you have no clue about it...better say few things(better say nothing my doctors and I need privacy....it's against health protocol what you experiment on...so the reaction might be on a seriously non positive direction) about my personal life! 
...
and/or Deep Purple Splat! pass-phrase<img width="225" height="225" alt="Splat!" src="https://github.com/user-attachments/assets/61e06193-9bcd-4205-9914-05f7d0021009" />


<img width="166" height="242" alt="Tolkien_book" src="https://github.com/user-attachments/assets/113eb61f-c363-419d-b374-c721be6835bc" />
I read this book(which is Tolkien's personal notes) which provides full evidence that Tolkien performed calculations to create the languages AND the (epic)books he created. If you haven't read it yet I recommend it-->of course it is importand to read the whole Tolkien bibliography. Our whole concept here is based on those ideas I'm honest with you. 
...
Blah blah without magic realism filtering of opinions and ideas is short of a hybrid/dirty talk...math and coding means guidance but this doesn't mean it can't become magic too/yet magic performance magic-talking/poetical performance also means words can weaken themselves as far as their original target is concerned(like a magic trick get's boring when you over-explain or repeat it). So all this concudes to magic trick-negotiation-->negotiation is many things over-negotiating again weakens the magic...of it. All this "discussion-seems-to-lead-nowhere" but new "trending talk for humanity" is religion and science combo...this is good news, since till now this was a taboo..this changes. Panspermia for example is a word someone can use to say that here there is pluralism in universe even we perceive it or not.
So, finally I like reading lately on stoicism Marcus Aurelius, perceiving philosophy as a mother, I listen much Jean Michel Jarre, Air french band and Ayreon(they are so cool)
Yet i've also read Stella Maris and the conclusion I jumped upon after reading it(I recommend it it's very good) is that indeed someone should make an objection on Math/coding/positive sciences foundation..if he is ready of course to work like (the hero of the book) overhours(on math/coding/positive sciences).
<img width="182" height="277" alt="Stella_Maris" src="https://github.com/user-attachments/assets/0ff684b9-3102-4a4e-a182-64453c11ec74" />
